...
test('пользователь авторизовался и произошел редирект на его профиль', async ({page}) => {
  await page.goto(ROUTE_PATH.auth)

  await page.getByPlaceholder('example@gmail.com').fill('prigodapawel@yandex.ru')
